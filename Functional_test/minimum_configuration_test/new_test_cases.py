...
test_cases2 = [
        {
        "name": "Test Set Unit Control",
        "send_command": {"uart_ack": 0x00,"message_type": 0x01, "message_id": 0x01,"data": [0x01, 0x02, 0x03,0x04, 0x05, 0x06,0x07, 0x08],"sequence_number": 0x00},
        "expected_response": {"message_type": 0x01, "message_id": 0x04, "error_code": 0x00,"sequence_number": 0x00},
    },
    {
        "name": "Test Get Unit Control",
    ...
    },
    {
        ...
        "send_command": {"uart_ack": 0x00, "message_type": 0x02, "message_id": 0x01, "data": [0x01,0x00, 0x01, 0x04], "sequence_number": 0x00},
